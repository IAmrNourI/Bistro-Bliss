                ...
                <div className='position-relative'>
                  ...
                  <div className='bg-contact'>
                    ...
                    <ul className='contact-ist p-0'>
                      <li><i className="fa-solid fa-phone"></i><span href="#">(414) 857 - 0107</span></li>
                      <li><i className="fa-regular fa-envelope"></i><span href="#">happytummy@restaurant.com</span></li>
                      <li><i className="fa-solid fa-location-dot"></i><span>837 W. Marshall Lane Marshalltown, IA 50158, Los Angeles</span></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-12 d-flex flex-column align-items-center justify-content-center">
              <div className="healthy-info ms-5 mt-5">
                ...
                <p>Our story began with a vision to create a unique dining experience that merges fine dining, 
                  exceptional service, and a vibrant ambiance. Rooted in city's rich culinary culture, we aim to honor our local roots while infusing a global palate.
                </p>
